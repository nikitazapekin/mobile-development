...
public class EarthquakeAdapter extends RecyclerView.Adapter<EarthquakeAdapter.EarthquakeViewHolder> {
    ...
    public interface OnEarthquakeClickListener {
        void onEarthquakeClick(EarthquakeResponse.Feature earthquake);
    }

    public EarthquakeAdapter(List<EarthquakeResponse.Feature> earthquakes, OnEarthquakeClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull EarthquakeViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> listener.onEarthquakeClick(earthquake));
    }
