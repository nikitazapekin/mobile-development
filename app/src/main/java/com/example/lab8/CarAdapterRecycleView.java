...
public class CarAdapterRecycleView {
}
*/
...
public class CarAdapterRecycleView extends RecyclerView.Adapter<CarAdapterRecycleView.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
           ...
           priceView = view.findViewById(R.id.price_text_view);
            descriptionView = view.findViewById(R.id.describtion_text_view);
        }
    }
}
...
public class CarAdapterRecycleView extends RecyclerView.Adapter<CarAdapter .ViewHolder>{

    private final LayoutInflater inflater;

    private final List<Car> cars;

    CarAdapterRecycleView (Context context, List<Car> pupils) {
        this.cars = cars;
        this.inflater = LayoutInflater.from(context) ;
    }

    @Override
    public CarAdapterRecycleView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
